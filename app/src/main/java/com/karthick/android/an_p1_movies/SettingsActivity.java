...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        Log.i("bindPreference", preference.getKey());
        String printval = PreferenceManager.getDefaultSharedPreferences(preference.getContext()).getString(preference.getKey(),"");
        Log.i("bindPreference", printval);
    ...
    public static class SortPreferenceFragment extends PreferenceFragment {
        ...
        public boolean onOptionsItemSelected(MenuItem item) {
            ...
            Log.i("onoptionsselected", getString(id));
